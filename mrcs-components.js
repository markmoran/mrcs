...
(function () {
    ...
    <section id="services" class="services-section">
      <div class="container">
        ...
        <div class="services-grid">
          <a href="mrcs-wf-crisis-v5.html" class="service-card" style="text-decoration:none;color:inherit;display:block;">
            <h4>Crisis Management</h4>
            <p>Locations, phone numbers &amp; hours for all crisis sites.</p>
          </a>
          <a href="mrcs-wf-counseling-v5.html" class="service-card" style="text-decoration:none;color:inherit;display:block;">
            <h4>Counseling &amp; Psychiatry</h4>
            <p>Outpatient mental health &amp; psychiatric services.</p>
          </a>
          <a href="mrcs-wf-wellness-v5.html" class="service-card" style="text-decoration:none;color:inherit;display:block;">
            <h4>Wellness &amp; Community Engagement</h4>
            <p>Community engagement and wellness programs.</p>
          </a>
          <a href="mrcs-wf-dev-disability-v5.html" class="service-card" style="text-decoration:none;color:inherit;display:block;">
            <h4>Developmental Disability</h4>
            <p>Support for individuals &amp; families.</p>
          </a>
          <a href="mrcs-wf-residential-v5.html" class="service-card" style="text-decoration:none;color:inherit;display:block;">
            <h4>Residential</h4>
            <p>Supervised residential living programs.</p>
          </a>
          <a href="mrcs-wf-community-based-v5.html" class="service-card" style="text-decoration:none;color:inherit;display:block;">
            <h4>Community-Based</h4>
            <p>In-home and community support services.</p>
          </a>
          <a href="mrcs-wf-case-management-v5.html" class="service-card" style="text-decoration:none;color:inherit;display:block;">
            <h4>Case Management</h4>
            <p>Coordinated care &amp; community support.</p>
          </a>
          <a href="mrcs-wf-ess-v5.html" class="service-card" style="text-decoration:none;color:inherit;display:block;">
  ...
  /* ----------------------------------------------------------
     ...
     Shared across all 8 individual service pages.
     Placeholder cards only — no real location names.
  ---------------------------------------------------------- */
  C.locationsService = `
    <section class="locations-service-section">
      <div class="container">
        <h2>Locations</h2>
        <p>Find a Mount Rogers location near you offering this service.</p>
        <div class="locations-map-placeholder">[Map Placeholder]</div>
        <div class="location-mini-grid">
          <div class="location-mini-card">
            <div class="location-mini-name">Location Name</div>
            <div class="location-mini-addr">Address Placeholder, VA</div>
            <div class="location-mini-phone">(888) 555-1234</div>
          </div>
          <div class="location-mini-card">
            <div class="location-mini-name">Location Name</div>
            <div class="location-mini-addr">Address Placeholder, VA</div>
        ...
        <div class="locations-service-cta">
          <a href="mrcs-wf-locations-v5.html" class="btn btn-secondary">View All Locations</a>
        </div>
      </div>
    </section>
  `;
  ...
  function run() {
    ...
    inject('mrcs-locations-service', C.locationsService);
